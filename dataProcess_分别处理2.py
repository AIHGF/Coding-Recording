...
if __name__ == '__main__':
    ...
    for epoch in range(27):
        ...
        init_train_poses_file = '/home/data/ddpose/test/init_train'+ str(epoch+1) +'.txt'
        target_train_poses_file = '/home/data/ddpose/test/target_train'+ str(epoch+1) +'.txt'
        target_control_train_file = '/home/data/ddpose/test/targetCorrection_train'+ str(epoch+1) +'.txt'
        f1 = open(init_train_poses_file, 'w')
        f2 = open(target_control_train_file, 'w')
        ...
        init_val_poses_file = '/home/data/ddpose/test/init_val'+ str(epoch+1) +'.txt'
        target_val_poses_file = '/home/data/ddpose/test/target_val'+ str(epoch+1) +'.txt'
        target_control_val_file = '/home/data/ddpose/test/targetCorrection_val'+ str(epoch+1) +'.txt'
